...
class LDA:
    ...
    def make_dfs(self):
        # training df
        training_users_tweets_dict = {x: get_tweets(x, self.rts, self.sentiment, self.limit, self.exclude)
        ...
        # testing df
        test_users_tweets_dict = {x: get_tweets(x, self.rts, self.sentiment, self.limit, self.exclude)
